...
//====================================================================
	 void RunTaste0(){
		 k0 = !k0 ;
                 Plot0->Kurve0->SetPen(Klar,3);
                 Plot1->Kurve3->SetPen(Klar,3);
	 }

	 void RunTaste1(){
		 k1 = !k1 ;
                 Plot0->Kurve1->SetPen(Klar,3);
                 Plot1->Kurve4->SetPen(Klar,3);
	 }

	 void RunTaste2(){
		 k2 = !k2 ;
                 Plot0->Kurve2->SetPen(Klar,3);
                 Plot1->Kurve5->SetPen(Klar,3);
	 }
